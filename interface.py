...
languages = [
    "English", "Hindi", "Bengali", "Spanish", "French", "German", "Mandarin", "Portuguese", "Italian", "Russian", "Arabic", "Korean", "Japanese", "Dutch", "Swedish", "Turkish", "Hebrew", "Tamil", "Urdu", "Indonesian", "Greek", "Polish", "Thai",
    "Vietnamese", "Filipino", "Malay", "Czech", "Hungarian", "Romanian", "Finnish", "Norwegian", "Danish", "Slovak", "Ukrainian", "Persian", "Hebrew", "Swahili", "Hausa", "Zulu", "Xhosa", "Igbo", "Yoruba", "Burmese", "Khmer", "Lao", "Sinhala", "Pashto", "Kurdish", "Basque", "Catalan", "Galician", "Maltese", "Luxembourgish", "Icelandic", "Welsh", "Scottish Gaelic", "Irish", "Maori", "Hawaiian", "Samoan", "Tongan", "Tahitian", "Chamorro", "Fijian", "Mongolian", "Tibetan", "Quechua", "Aymara", "Guarani", "Haitian Creole", "Twi", "Amharic", "Tigrinya", "Oromo", "Shona", "Sesotho", "Tswana", "Sindhi", "Nepali", "Kashmiri", "Assamese", "Marathi", "Gujarati", "Punjabi", "Kannada", "Malayalam", "Telugu", "Santali", "Meitei", "Bodo", "Dogri", "Konkani", "Maithili", "Bhili", "Gondi", "Tulu", "Bishnupriya", "Manipuri", "Sylheti"
]
...
audiences = ["Students", "Job Seekers", "Entrepreneurs", "Managers", "Developers", "Freelancers", "Marketers", "CXOs", "Consultants", "Researchers", "Startups", "HR Professionals", "Sales Executives", "Creatives", "Public Speakers", "Investors", "Educators", "Healthcare Professionals", "Government Officials", "Corporate Employees", "Product Managers", "UX Designers", "Finance Experts", "Influencers", "Venture Capitalists", "Policy Makers", "Tech Enthusiasts", "Non-Profit Leaders", "Customer Success Managers", "Academicians", "Small Business Owners", "Legal Experts", "Content Creators", "Software Engineers", "Business Analysts"]
purposes = ["Informative", "Promotional", "Storytelling", "Personal Experience", "Industry Trends", "Educational", "Community Building", "Customer Engagement", "Motivational", "Brand Awareness", "Recruitment", "Networking", "Awareness", "Case Study", "How-To", "Tips & Tricks", "Behind-the-Scenes", "Event Promotion", "News & Updates", "Product Launch", "Market Analysis", "Opinion Piece", "Experience Sharing", "CSR Initiatives", "Webinar Promotion", "Podcast Announcement", "Survey Results", "Milestone Celebration", "Partnership Announcement", "Crowdfunding Campaign", "Social Advocacy", "Tech Innovation", "User Testimonials", "Thought Leadership"]
